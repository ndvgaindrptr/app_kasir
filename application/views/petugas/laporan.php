...
<div class="container-fluid">
    ...
    <?php if ($transaksi != null) : ?>
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Data Transaksi Mulai Tanggal <?= date('d-m-Y', strtotime($tanggal['awal']))  ?> Sampai Tanggal <?= date('d-m-Y', strtotime($tanggal['akhir']))  ?></h6>
                <a target="_blank" href="<?= base_url('petugas/cetaklaporan/' . $tanggal['awal'] . '/' . $tanggal['akhir']) ?>" class="btn btn-primary float-right"><i class="fas fa-print"></i> Cetak</a>
            </div>
            <div class="card-body">
