...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <a href="<?= base_url('petugas/tambahproduk') ?>" class="btn btn-primary float-right">Tambah Produk</a>
                    ...
                    <tbody>
                        ...
                        foreach ($produk as $p) : ?>
                            <tr>
                                ...
                                <td><?= $p['stok'] ?></td>
                                <td>
                                    <a href="<?= base_url('petugas/editproduk/' . $p['id_produk']) ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
