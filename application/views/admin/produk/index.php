...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <a href="<?= base_url('admin/tambahproduk') ?>" class="btn btn-primary float-right">Tambah Produk</a>
                    ...
                    <tbody>
                        ...
                        foreach ($produk as $p) : ?>
                            <tr>
                                ...
                                <td><?= $p['stok'] ?></td>
                                <td>
                                    <a href="<?= base_url('admin/editproduk/' . $p['id_produk']) ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
    ...
    <div class="modal fade" id="hapus<?= $p['id_produk'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?= base_url('admin/hapusproduk/' . $p['id_produk']) ?> " method="post">
    ...
    <div class="modal fade" id="stok<?= $p['id_produk'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?= base_url('admin/stokproduk/' . $p['id_produk']) ?> " method="post">
                    <div class="modal-body">
