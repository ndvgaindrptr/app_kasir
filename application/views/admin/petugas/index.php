...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <a href="<?= base_url('admin/tambahpetugas') ?>" class="btn btn-primary float-right"><i class="fas fa-user-plus"></i> Tambah Petugas</a>
                    ...
                    <tbody>
                        ...
                        foreach ($petugas as $p) : ?>
                            <tr>
                                ...
                                <td><?= $p['alamat'] ?></td>
                                <td>
                                    <a href="<?= base_url('admin/editpetugas/' . $p['id_user']) ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
