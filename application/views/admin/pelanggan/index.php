...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <a href="<?= base_url('admin/tambahpelanggan') ?>" class="btn btn-primary float-right"><i class="fas fa-user-plus"></i> Tambah Pelanggan</a>
                    ...
                    <tbody>
                        ...
                        foreach ($pelanggan as $p) : ?>
                            <tr>
                                ...
                                <td><?= $p['no_telepon'] ?></td>
                                <td>
                                    <a href="<?= base_url('admin/editpelanggan/' . $p['id_pelanggan']) ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
